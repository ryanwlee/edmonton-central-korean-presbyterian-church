      ...
      >
        <div className={classes.paper}>
          ...
          >
            ...
            <p className={classes.indent}>
              ...
              *웹 주소: www.edmontoncc.net 접속, LIVE를 클릭하시면 됩니다.
              <br />
              5) 주일 예배는 가족이 주일예배를 드리는 것과 다름없이 깨끗한 옷을
              입고 정숙한 마음으로 참여합니다.
              <br />
              ...
              봉헌합니다. 드려진 헌금은 부모가 정성껏 보관하다가 다시 교회당에
              모여 예배하게 될 때 헌금 해 주시면 감사하겠습니다.
              <br />
          ...
          >
            ...
            거하시기를 바랍니다. 우리 주 하나님은 우리의 피난처시요 힘이십니다.
            환난 중에 만날 큰 도움이십니다. <br />
            <br />
            <b>
              사 43:2, 3 “2네가 물 가운데로 지날 때에 내가 너와 함께 할 것이라
              강을 건널 때에 물이 너를 침몰하지 못할 것이며 네가 불 가운데로
              지날 때에 타지도 아니할 것이요 불꽃이 너를 사르지도 못하리니 3대저
              나는 여호와 네 하나님이요 이스라엘의 거룩한이요 네 구원자임이라”
            </b>
            <br />
            <br />
